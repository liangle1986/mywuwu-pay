...
public class AlipayConfig1 {
    ...
    //沙箱三方登录授权url
    public static String login_url = "https://openauth.alipaydev.com/oauth2/publicAppAuthorize.htm?app_id=" + AlipayConfig1.APPID + "&scope=auth_user&redirect_uri=" + AlipayConfig1.return_url + "&state=init";
}
